...
class Pagina6():
    ...
    def ConsultarListas(self):
        c = self.conn.cursor()
        c.execute("SELECT * FROM ListasDeSalidas")

        Dato = c.fetchall()
        #c.close()
        return Dato

    def ConsultarListasR(self,filtro):
        c = self.conn.cursor()
        consulta = f"SELECT * FROM ListasDeSalidas ORDER BY {filtro} DESC"
        c.execute(consulta)
    ...
    def BuscarListas(self, Clave):
        c = self.conn.cursor()
        buscar = "SELECT * FROM ListasDeSalidas WHERE Folio= '{}'".format(Clave)
        c.execute(buscar)
    ...
    def BuscarListasN(self, Clave):
        c = self.conn.cursor()
        buscar = "SELECT * FROM ListasDeSalidas WHERE Obra= '{}'".format(Clave)
        c.execute(buscar)
    ...
    def AgregarListasL(self,Lista):
        c = self.conn.cursor()
        Agregar = "INSERT INTO ListasDeSalidas VALUES (NULL,?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)"
    ...
    def EliminarListas(self, Clave):
        c = self.conn.cursor()
        Elimiar = "DELETE FROM ListasDeSalidas WHERE Folio='{}'".format(Clave)
        c.execute(Elimiar)
        n = c.rowcount
        self.conn.commit()
        c.close()
    ...
    def ActualizarListasL(self, ID, Lista):
        c = self.conn.cursor()
