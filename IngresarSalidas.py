...
class Pagina5():
    ...
    def ConsultarSalidas(self):
        c = self.conn.cursor()
        c.execute("SELECT * FROM RegistroSalidas")

        Dato = c.fetchall()
        #c.close()
        return Dato
    
    def ConsultarSalidasR(self, filtro):
        c = self.conn.cursor()
        consulta = f"SELECT * FROM RegistroSalidas ORDER BY {filtro} DESC"
        c.execute(consulta)
    ...
    def BuscarSalidas(self, Clave):
        c = self.conn.cursor()
        buscar = "SELECT * FROM RegistroSalidas WHERE Folio= '{}'".format(Clave)
        c.execute(buscar)
    ...
    def BuscarSalidasN(self, Clave):
        c = self.conn.cursor()
        buscar = "SELECT * FROM RegistroSalidas WHERE Obra= '{}'".format(Clave)
        c.execute(buscar)
    ...
    def AgregarSalidasL(self,Lista):
        c = self.conn.cursor()
        Agregar = "INSERT INTO RegistroSalidas VALUES(NULL,?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)"
    ...
    def EliminarSalidas(self, Clave):
        c = self.conn.cursor()
        Elimiar = "DELETE FROM RegistroSalidas WHERE Folio='{}'".format(Clave)
        c.execute(Elimiar)
        n = c.rowcount
        self.conn.commit()
        c.close()
    ...
    def ActualizarSalidasL(self, ID, Lista):
        c = self.conn.cursor()
